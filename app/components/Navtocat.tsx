...
function Navtocat() {
  const Box = ({imageSrc,Name,HoverImage}:ros)=>{
    ...
    <Image width={500} height={500} className='w-full transition-opacity absolute ease-in-out opacity-0 group-hover:animate-fadeIn h-full object-cover' src={`${HoverImage}`} alt={`${Name}`}/>
