...
function Navtocat() {
  const Box = ({imageSrc,Name}:ros)=>{
    return  <div className='w-full relative  md:h-[17.4739375em] md:w-[25%]  h-[18.203125em]  border border-black '>
    <Image blurDataURL={imageSrc}  placeholder="blur" className='w-full h-full object-cover' width={500} height={500} src={`${imageSrc}`} alt={`${Name}`}/>
