...
function Imagecarousel({arrayofImages,Tag}:{arrayofImages:string[],Tag:string}) {
  return (
   ...
   {/* <button onClick={addToBagFunc} type="button" className={`${font.className} z-[20] transition-all duration-[120ms] ease-in-out opacity-0 group-hover:lg:opacity-100 bg-white rounded-full py-[0.25em] px-[0.75em] text-[0.75em] absolute bottom-2 font-[500] text-black tracking-[1px] right-2`}>ADD TO BAG</button> */}
