...
function ShopTitle() {
  return (
    <div className='flex top-[3.6em] lg:z-[99999] z-[50] bg-white justify-between lg:top-[3.6em] sticky md:top-[3.6em] border border-b-2 border-b-gray-100 h-max  p-[.4em]'>
