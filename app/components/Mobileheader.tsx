...
function Mobileheader() {
  return (
    ...
    <Image className='w-[1em] mr-[1em] h-[1em]' src="/headericons/Wishlist.svg" alt='menu' width={500} height={500}/>
    <Image className='w-[1em] mr-[1em] h-[1em]' src="/headericons/Cart.svg" alt='menu' width={500} height={500}/>
    </div>
    </div>
    </>
  )
